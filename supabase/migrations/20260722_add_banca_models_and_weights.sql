...
alter table configuracoes_sistema
  add column if not exists banca_modelos_config jsonb not null default '{"grade_completa":{"pesos":[33.33,33.33,33.34]},"grade_banca":{"pesos":[33.33,33.33,33.34]},"nota_direta":{"pesos":[100]}}'::jsonb;
